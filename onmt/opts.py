...
def model_opts(parser):
    ...
    group.add('--enc_layers', '-enc_layers', type=int, default=3,
              help='Number of layers in the encoder')
    group.add('--dec_layers', '-dec_layers', type=int, default=3,
    ...
    group.add('--enc_rnn_size', '-enc_rnn_size', type=int, default=1024,
              help="Size of encoder rnn hidden states. "
                   "Must be equal to dec_rnn_size except for "
                   "speech-to-text.")
    group.add('--dec_rnn_size', '-dec_rnn_size', type=int, default=1024,
...
def translate_opts(parser):
    ...
    group.add('--shard_size', '-shard_size', type=int, default=10000,
              help="Divide src and tgt (if applicable) into "
                   ...
                   "shard_size>0 means segment dataset into multiple shards, "
                   "each shard has shard_size samples")
    group.add('--output', '-output', default='txt/pred.jp',
